...
spells_db: List[Spell] = [
    ...
    Spell(id=6, name="Invisibility", level=2, school="Illusion",
          ...
          image_url="http://127.0.0.1:8000/static/images/invisible.png"
          ),
    Spell(id=7, name="Magic Missile", level=1, school="Evocation",
          ...
          image_url="http://127.0.0.1:8000/static/images/missile.png"),
    Spell(id=8, name="Web", level=2, school="Conjuration",
          ...
          image_url="http://127.0.0.1:8000/static/images/web.png"),
    Spell(id=9, name="Fire Shield", level=4, school="Abjuration",
          ...
          image_url="http://127.0.0.1:8000/static/images/fire_shield.png"),
    Spell(id=10, name="Fog Cloud", level=1, school="Conjuration",
          ...
          image_url="http://127.0.0.1:8000/static/images/fog.png"),
]
...
async def create_spell(
    ...
    try:
        ...
        if imageUrl:
            ...
            image_url = "http://127.0.0.1:8000/static/images/default_spell_image.png"
...
async def update_spell(
    ...
    try:
        ...
        if imageUrl:
            ...
            with open(file_location, "wb+") as file_object:
                file_object.write(await imageUrl.read())
            spell_to_update.image_url = f"http://127.0.0.1:8000/{
                file_location}"
        else:
            spell_to_update.image_url = "http://127.0.0.1:8000/static/images/default_spell_image.png"
